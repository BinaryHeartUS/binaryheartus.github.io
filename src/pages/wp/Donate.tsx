        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-12">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
              Donate to <BinaryHeartText /> at Walter Payton
            </h1>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-8 shadow-lg ring-1 ring-gray-900/5">
                ...
                <form 
                  action="https://docs.google.com/forms/d/e/1FAIpQLSerS4FbCTq9bVtzZ-YrwRmsdjbHeYFz8SuB2KMD4uxKQf5v9Q/formResponse" 
                  method="POST"
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    <button
                      type="submit"
                      className={`w-full rounded-lg bg-gradient-to-r ${WALTER_PAYTON_COLORS.GRADIENT_ORANGE} px-6 py-3 text-base font-semibold text-white shadow-lg ${WALTER_PAYTON_COLORS.GRADIENT_ORANGE_HOVER} transition-all duration-200`}
                    >
