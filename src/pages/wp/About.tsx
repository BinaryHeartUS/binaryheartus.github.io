        ...
        <div className="mx-auto max-w-7xl px-6 pb-12 pt-10 sm:pb-16 lg:px-8 lg:pt-16">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl mb-6">
              About <BinaryHeartText /> at Walter Payton
            </h1>
            <p className="text-xl leading-8 text-gray-700">
              Bridging the digital divide through technology recycling and student empowerment at Walter Payton College Prep.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-lg text-gray-600 space-y-4">
              <p>
                Founded in 2025, Binary Heart at Walter Payton College Prep is part of a nationwide movement to make technology accessible to everyone. As students at one of Chicago's premier selective enrollment schools, we leverage our passion for service and technology to refurbish and redistribute computers to those in need.
              </p>
              <p>
                We combine Walter Payton's commitment to academic excellence and community engagement with Binary Heart's proven model of student-led service. Our chapter works to ensure that students, families, and community organizations throughout Chicago have access to the technology they need to succeed in an increasingly digital world.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Making a difference in the Chicago community
            </p>
          </div>

          <StatsGrid chapterId="wp" colorClass={WALTER_PAYTON_COLORS.TEXT_BLUE} columns={3} />
        </div>
      </div>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="space-y-6">
              <InfoCard
                ...
                bgColorClass={WALTER_PAYTON_COLORS.BG_BLUE_LIGHT}
                iconColorClass={WALTER_PAYTON_COLORS.TEXT_BLUE}
              />
              ...
              <InfoCard
                ...
                description="Refurbished devices are distributed to students, families, and community organizations in need—both locally in Chicago and internationally. Through partnerships with schools, nonprofits, and social service agencies, we ensure technology reaches those who need it most."
                bgColorClass={WALTER_PAYTON_COLORS.BG_BLUE_LIGHT}
                iconColorClass={WALTER_PAYTON_COLORS.TEXT_BLUE}
              />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Whether you're a Walter Payton student looking to make a difference or someone with equipment to donate, there are many ways to get involved with Binary Heart.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="/wp/join"
                className={`rounded-xl bg-gradient-to-r ${WALTER_PAYTON_COLORS.GRADIENT_BLUE} px-6 py-3 text-base font-semibold text-white shadow-lg ${WALTER_PAYTON_COLORS.GRADIENT_BLUE_HOVER} transition-all duration-300 hover:scale-105 hover:shadow-xl`}
              >
                Join Our Chapter
              </a>
              <a
                href="/wp/donate"
                className={`rounded-xl bg-gradient-to-r ${WALTER_PAYTON_COLORS.GRADIENT_ORANGE} px-6 py-3 text-base font-semibold text-white shadow-lg ${WALTER_PAYTON_COLORS.GRADIENT_ORANGE_HOVER} transition-all duration-300 hover:scale-105 hover:shadow-xl`}
              >
                Donate Equipment
              </a>
            </div>
