...
export default function About() {
  ...
  return (
    <main className="grow relative z-10">
        ...
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          <div className="text-center">
            <a
              ...
              className="inline-flex items-center gap-2 text-gray-600 hover:text-[#a01010] transition-colors"
            >
      ...
      {/* Leadership Team */}
      <div className="py-8 sm:py-12 bg-gradient-to-b from-[#a01010]/5 to-transparent">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-8">
      ...
      <div className="py-8 sm:py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="relative rounded-2xl bg-gradient-to-br from-[#a01010] to-[#800000] p-8 sm:p-12 shadow-2xl overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-6">
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-lg bg-white px-6 py-3 text-base font-semibold text-[#a01010] shadow-sm hover:bg-gray-50 transition-colors"
                  >
                    Become a Volunteer
                  </a>
                  <a
