        ...
        <div className="mx-auto max-w-7xl px-6 pb-12 pt-10 sm:pb-16 lg:px-8 lg:pt-16">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl mb-6">
              About <span className="text-[#2F4A70]">Binary</span>
              <span className="text-[#FF0040]">Heart</span> at Rose-Hulman Institute of Technology
            </h1>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Making a difference in the Terre Haute community
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Device Collection & Assessment</h3>
                    <p className="text-gray-600">
                      We accept donations of laptops, desktops, tablets, and other electronics from individuals, businesses, and organizations. Each device is carefully assessed to determine if it can be refurbished or should be responsibly recycled.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Expert Refurbishment</h3>
                    <p className="text-gray-600">
                      Our engineering students diagnose hardware issues, perform repairs, upgrade components when possible, securely wipe all data, and install fresh operating systems and essential software. Every device leaves our lab in excellent working condition.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Community Distribution</h3>
                    <p className="text-gray-600">
                      Refurbished devices are distributed to students, families, and community organizations in need—both locally in Terre Haute and internationally. Through partnerships with schools, nonprofits, and social service agencies, we ensure technology reaches those who need it most.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600">
                      Our volunteers gain hands-on experience with hardware troubleshooting, software installation, data security, project management, and community outreach—skills that are invaluable for future careers in engineering and technology.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5 text-center">
                <div className="mb-4 mx-auto h-32 w-32 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                  <img 
                    src="/assets/images/chapters/rose-hulman/people/TalBelkind.jpg" 
                    alt="Tal Belkind" 
                    className="h-full w-full object-cover"
                  />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Tal Belkind</h3>
                <p className="text-sm text-gray-600 mb-1">President</p>
                <p className="text-xs text-gray-500">Technology Director of National 501(c)(3)</p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5 text-center">
                <div className="mb-4 mx-auto h-32 w-32 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                  <img 
                    src="/assets/images/chapters/rose-hulman/people/JosephZeru.jpg" 
                    alt="Joseph Zeru" 
                    className="h-full w-full object-cover"
                  />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Joseph Zeru</h3>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5 text-center">
                <div className="mb-4 mx-auto h-32 w-32 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                  <img 
                    src="/assets/images/chapters/rose-hulman/people/HunterSnyder.jpg" 
                    alt="Hunter Snyder" 
                    className="h-full w-full object-cover"
                  />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Hunter Snyder</h3>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5 text-center">
                <div className="mb-4 mx-auto h-32 w-32 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                  <img 
                    src="/assets/images/chapters/rose-hulman/people/JackLucas.jpg" 
                    alt="Jack Lucas" 
                    className="h-full w-full object-cover"
                  />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Jack Lucas</h3>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5 text-center">
                <div className="mb-4 mx-auto h-32 w-32 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                  <img 
                    src="/assets/images/chapters/rose-hulman/people/AnthonyFlores.jpg" 
                    alt="Anthony Flores" 
                    className="h-full w-full object-cover"
                  />
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Anthony Flores</h3>
