        ...
        <div className="mx-auto max-w-7xl px-6 pb-12 pt-10 sm:pb-16 lg:px-8 lg:pt-20">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mb-16">
              <Link
                to="/rose-hulman/join"
                className="group relative rounded-2xl bg-gradient-to-br from-[#a01010]/90 to-[#800000]/90 px-8 py-4 text-base font-semibold text-white shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:scale-105 hover:from-[#a01010] hover:to-[#800000]"
              >
              ...
              <Link
                ...
                className="group relative rounded-2xl bg-gradient-to-br from-[#8a8a8a]/90 to-[#6a6a6a]/90 px-8 py-4 text-base font-semibold text-white shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:scale-105 hover:from-[#8a8a8a] hover:to-[#6a6a6a]"
              >
          ...
          {/* Impact Stats */}
          <StatsGrid chapterId="rose-hulman" colorClass="text-[#a01010]" columns={3} />
        </div>
      </div>
          ...
          <div className="mx-auto max-w-3xl">
            <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-8 shadow-xl ring-1 ring-gray-900/5">
              ...
              <div className="flex justify-center">
                <Link
                  to="/rose-hulman/join"
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#a01010] to-[#800000] px-6 py-3 text-base font-semibold text-white shadow-lg hover:from-[#b01818] hover:to-[#900808] transition-all duration-200"
                >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-8 md:grid-cols-2">
              {/* Join as Member */}
              <div className="relative rounded-2xl bg-gradient-to-br from-[#a01010]/90 to-[#800000]/90 backdrop-blur-sm p-8 shadow-xl text-white">
