          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-8">
                  ...
                  <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:rose-hulman@binaryheart.org" className="text-blue-600 hover:text-blue-700">
                  ...
                  <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Olin Hall, Room 231</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
                  ...
                  <div className="space-y-2">
                    <a href="/rose-hulman/join" className="flex items-center gap-2 text-blue-600 hover:text-blue-700">
                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                      </svg>
                      <span>Join Our Chapter</span>
                    </a>
                    <a href="/rose-hulman/about" className="flex items-center gap-2 text-blue-600 hover:text-blue-700">
                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                      </svg>
              ...
              <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-8 shadow-lg ring-1 ring-gray-900/5">
                ...
                <form 
                  action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSe1v16uhPoogZRZ9OpleQaXBrmtuRah-9NY34ttaeax-jdNFw/formResponse" 
                  method="POST"
                  target="_blank"
