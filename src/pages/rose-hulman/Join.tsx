      ...
      <div className="py-8 sm:py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="relative rounded-2xl bg-gradient-to-br from-blue-500/90 to-indigo-600/90 backdrop-blur-sm p-8 sm:p-12 shadow-xl text-white">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Hands-On Tech Skills</h3>
                <p className="text-gray-600">
                  Learn computer repair, operating system installation, hardware troubleshooting, and data security practices.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600">
                  Connect with students across majors, faculty mentors, and professionals in the tech industry.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600">
                  Make a real difference in the Terre Haute community by providing technology to those who need it most.
                </p>
              </div>

              {/* Benefit 4 */}
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 text-white">
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.06-.312m-2.24 2.39a4.493 4.493 0 00-1.757 4.306 4.493 4.493 0 004.306-1.758M16.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Leadership Experience</h3>
                <p className="text-gray-600">
                  Take on roles leading projects, organizing events, and managing teams—great for your resume.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Flexible Commitment</h3>
                <p className="text-gray-600">
                  Participate as much or as little as your schedule allows. Drop in for a meeting or get deeply involved—it's up to you.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600">
                  Stand out in internship and job applications with meaningful volunteer work and demonstrated technical skills.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-4xl space-y-6">
            ...
            <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Computer Refurbishment</h3>
                  <p className="text-gray-600">
                    Learn to diagnose hardware issues, upgrade components, clean and test systems, and prepare computers for distribution.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Software Installation & Security</h3>
                  <p className="text-gray-600">
                    Install operating systems, set up essential software, configure security settings, and ensure devices are ready to use.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Collection & Distribution</h3>
                  <p className="text-gray-600">
                    Organize donation drives, coordinate with local organizations, and distribute refurbished devices to students and families in need.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600">
                    Build relationships with local schools, nonprofits, and community organizations to identify technology needs and maximize our impact.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <a
                      ...
                      className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
                    >
