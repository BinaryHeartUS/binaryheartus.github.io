      ...
      <div className="py-8 sm:py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className={`relative rounded-2xl bg-gradient-to-br ${ROSE_HULMAN_COLORS.GRADIENT_PRIMARY_90} backdrop-blur-sm p-6 sm:p-8 md:p-12 shadow-xl text-white`}>
              <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
                ...
                <div className="flex-1 text-center sm:text-left">
                  <h2 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3">Weekly Meetings</h2>
                  <p className="text-lg sm:text-xl text-white/90 mb-1 sm:mb-2">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <FeatureCard
                ...
                description="Make a real difference in the Terre Haute community by providing technology to those who need it most."
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-4 sm:p-6 md:p-8 shadow-xl ring-1 ring-gray-900/5">
                <div className="flex items-start gap-3 sm:gap-4 md:gap-6">
                  <div className="flex-shrink-0">
                    <div className={`flex h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 items-center justify-center rounded-xl bg-gradient-to-br ${ROSE_HULMAN_COLORS.GRADIENT_PRIMARY} text-white`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <a
                      ...
                      className={`group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r ${ROSE_HULMAN_COLORS.GRADIENT_PRIMARY} px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl`}
                    >
                      <span className="break-words">Join on Campus Groups</span>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-4 sm:p-6 md:p-8 shadow-xl ring-1 ring-gray-900/5">
                <div className="flex items-start gap-3 sm:gap-4 md:gap-6">
                  <div className="flex-shrink-0">
                    <div className="flex h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="rounded-xl bg-gray-100 px-4 sm:px-6 py-3 sm:py-4 text-center">
              ...
              {/* In-Person Info */}
              <div className={`relative rounded-2xl bg-gradient-to-br ${ROSE_HULMAN_COLORS.GRADIENT_SECONDARY} backdrop-blur-sm p-4 sm:p-6 md:p-8 shadow-xl text-white`}>
                <div className="flex items-start gap-3 sm:gap-4 md:gap-6">
                  <div className="flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm sm:text-base text-white/90 mb-3 sm:mb-4 break-words">
                      Sign up on Campus Groups to get notifications about our next meeting and events. We meet Fridays at 5:00 PM in Olin 231—join Campus Groups to stay updated!
                    </p>
                    <ul className="space-y-2 text-xs sm:text-sm text-white/90">
                      <li className="flex items-start gap-2">
                        ...
                        <span className="break-words">Get meeting reminders and updates</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <svg className="h-5 w-5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span className="break-words">Stay informed about event details</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <svg className="h-5 w-5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            <div className="mt-8 sm:mt-12 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3 sm:gap-4 px-2">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-lg bg-white px-4 sm:px-6 py-2.5 sm:py-3 text-sm font-semibold text-gray-900 shadow-md ring-1 ring-gray-900/5 transition-all duration-300 hover:scale-105 hover:shadow-lg whitespace-nowrap"
                >
