          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Real-World Tech Skills</h3>
                <p className="text-gray-600">
                  Learn hardware repair, OS installation, data security, and troubleshooting from experienced mentors.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600">
                  Start or lead a chapter at your school, manage teams, and develop organizational skills.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600">
                  Make a tangible difference by helping students and families access essential technology.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">College & Career Boost</h3>
                <p className="text-gray-600">
                  Stand out on applications with meaningful volunteer work and technical expertise.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600">
                  Connect with like-minded students, mentors, and professionals in the tech industry.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600">
                  Work around your classes and commitments with volunteer opportunities that fit your schedule.
                </p>
              </div>
            </div>
          </div>
