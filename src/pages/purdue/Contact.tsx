              ...
              <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-8 shadow-lg ring-1 ring-gray-900/5">
                ...
                >
                  ...
                  <div>
                    <button
                      type="submit"
                      className={`w-full rounded-lg bg-gradient-to-r ${PURDUE_COLORS.GRADIENT_PRIMARY} px-6 py-3 text-base font-semibold text-white shadow-lg ${PURDUE_COLORS.GRADIENT_PRIMARY_HOVER} transition-all duration-200`}
                    >
                      Send message
                    </button>
                  </div>
