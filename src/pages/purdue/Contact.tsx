          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-8">
                  ...
                  <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:purdue@binaryheart.org" className="text-amber-600 hover:text-amber-700">
                  ...
                  <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+12197433988" className="text-yellow-600 hover:text-yellow-700">
                          (219) 743-3988
                        </a>
                      </div>
                    </div>
                ...
                <div className="rounded-2xl bg-gradient-to-br from-amber-50 to-yellow-50 p-6">
                  ...
                  <div className="space-y-2">
                    <a href="/purdue/join" className="flex items-center gap-2 text-amber-600 hover:text-amber-700">
                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                      </svg>
                      <span>Join Our Chapter</span>
                    </a>
                    <a href="/purdue/about" className="flex items-center gap-2 text-amber-600 hover:text-amber-700">
                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                      </svg>
                      <span>Learn About Us</span>
                    </a>
                    <a href="/purdue/donate" className="flex items-center gap-2 text-amber-600 hover:text-amber-700">
                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                      </svg>
              ...
              <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-8 shadow-lg">
                ...
                <form 
                  action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSfj7W0pGl81PBl_QEAYQbVGojArN0FJx-PeU3MZFudt3SSdPA/formResponse" 
                  method="POST"
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded-lg bg-gradient-to-r from-amber-500 to-yellow-600 px-6 py-3 text-base font-semibold text-white shadow-lg hover:from-amber-600 hover:to-yellow-700 transition-all duration-200"
                    >
                      Send message
                    </button>
                  </div>
