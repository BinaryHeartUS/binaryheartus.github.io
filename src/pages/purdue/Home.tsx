      ...
      <div className="relative isolate overflow-hidden min-h-screen flex items-center">
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          ...
          <div className="mx-auto max-w-3xl text-center">
            {/* Badge */}
            <div className="mb-8">
              <Link to="/purdue/about" className="hidden sm:inline-flex items-center space-x-2 rounded-full bg-white/80 backdrop-blur-sm px-4 py-2 text-sm font-medium text-gray-700 ring-1 ring-gray-900/10 hover:bg-white transition-colors">
                <img src="/assets/images/chapters/purdue/icon.svg" alt="" className="h-5 w-5" />
            ...
            <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-7xl mb-6">
              <BinaryHeartText /> at Purdue
            </h1>

            {/* Subheadline */}
            <p className="text-xl leading-8 text-gray-700 mb-10">
              Boilermakers refurbishing technology to bridge the digital divide in Greater Lafayette and beyond.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <FeatureCard
                title="Distribution"
                description="Deliver refurbished devices to students and families in need throughout the Greater Lafayette community."
                icon={
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className={`relative rounded-2xl bg-gradient-to-br ${PURDUE_COLORS.GRADIENT_PRIMARY_90} backdrop-blur-sm p-8 shadow-xl text-white`}>
                ...
                <p className="text-white/90 mb-6">
                  Join our team of Boilermakers making a difference. Gain hands-on experience while helping your community.
                </p>
                <Link
                  to="/purdue/join"
