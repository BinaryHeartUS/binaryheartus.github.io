        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-lg text-gray-600 space-y-4">
              <p>
                Binary Heart at Purdue University is part of a nationwide movement to make technology accessible to everyone. As students at a leading research institution, we leverage our technical expertise and passion for service to refurbish and redistribute technology to those in need.
              </p>
              <p>
