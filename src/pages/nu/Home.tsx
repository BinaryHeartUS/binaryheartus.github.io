...
export default function Home() {
  ...
  return (
    <main className="grow relative z-10">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-8 md:grid-cols-3">
              <FeatureCard
                ...
                description="Diagnose, repair, and upgrade donated computers and electronics to like-new condition."
                icon={
              ...
              <FeatureCard
                title="Distribution"
                description="Deliver refurbished devices to students and families in need throughout the Evanston and Chicago communities."
                icon={
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
      ...
      <div className="py-12 sm:py-16 bg-gradient-to-br from-gray-50 to-purple-50/30">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
