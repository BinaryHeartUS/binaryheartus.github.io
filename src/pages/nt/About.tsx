      ...
      <div className="py-8 sm:py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-lg text-gray-600 space-y-4">
              <p>
                Binary Heart is a student-run 501(c)(3) nonprofit organization that was founded right here at New Trier High School in 2016. Since then, we've grown into a nationwide network of chapters, each working to address the digital divide in their local communities.
              </p>
              <p>
