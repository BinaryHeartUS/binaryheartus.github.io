          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              <div className="flex flex-col items-center text-center">
                <div className="text-5xl font-bold text-blue-600 mb-2">${formatNumber(aggregateStats.devicesValue)}+</div>
                <div className="text-sm text-gray-600">Value of Devices Donated</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="text-5xl font-bold text-blue-600 mb-2">{aggregateStats.volunteerCount}+</div>
                <div className="text-sm text-gray-600">Student Volunteers</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="text-5xl font-bold text-blue-600 mb-2">{chapterCount}</div>
                <div className="text-sm text-gray-600">Active Chapters</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="text-5xl font-bold text-blue-600 mb-2">{formatNumber(aggregateStats.volunteerHours)}+</div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600 text-sm">
                  Technology should be available to everyone, regardless of economic background.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600 text-sm">
                  We keep electronics out of landfills and extend their useful life through refurbishment.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600 text-sm">
                  We empower students with hands-on technical skills and real-world experience.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600 text-sm">
                  We build strong local networks of volunteers, donors, and recipients working together.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600 text-sm">
                  We operate openly, sharing our processes, impact, and financials with our community.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/60 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                ...
                <p className="text-gray-600 text-sm">
                  We continuously improve our processes and explore new ways to maximize our impact.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">100% Student-Run</h3>
                    <p className="text-gray-600">
                      Every aspect of Binary Heart—from operations to leadership—is managed by students. This ensures fresh perspectives, innovative solutions, and authentic connection with the communities we serve.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Skill-Building Focus</h3>
                    <p className="text-gray-600">
                      We're not just recycling computers—we're building the next generation of tech professionals. Volunteers gain real-world experience in hardware, software, networking, and project management.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Data Security First</h3>
                    <p className="text-gray-600">
                      We use industry-standard data wiping procedures to ensure all donated devices are completely secure before redistribution. Privacy and security are never compromised.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl bg-white/80 backdrop-blur-sm p-6 shadow-lg ring-1 ring-gray-900/5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Local Impact, National Scale</h3>
                    <p className="text-gray-600">
                      Each chapter operates independently to serve their local community's unique needs, while benefiting from national resources, partnerships, and best practices.
                    </p>
                  </div>
                </div>
              </div>
