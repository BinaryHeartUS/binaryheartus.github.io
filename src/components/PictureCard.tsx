...
export default function PictureCard({ imageSrc, name, role, linkedin, github, instagram, email }: PictureCardProps) {
  const hasSocialLinks = linkedin || github || instagram || email;
      ...
      {hasSocialLinks && (
        <div className="flex justify-center gap-3 mt-3 pt-3 border-t border-gray-200">
          ...
          {email && (
            <a
              href={`mailto:${email}`}
              className="text-gray-600 hover:text-[#EA4335] transition-colors"
