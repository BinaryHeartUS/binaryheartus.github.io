...
export default function WhyJoin({ communityName }: WhyJoinProps) {
  return (
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <FeatureCard
              ...
              description={`Make a real difference in the ${communityName} community by providing technology to those who need it most.`}
